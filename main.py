...
if tab_selector == "Graph":
    ...
    print("Columns and Data Types of Individual Criminal Cases DataFrame:")
    print(individual_criminal_cases.dtypes)
    print("Top 10 Records of Individual Criminal Cases DataFrame:")
    print(individual_criminal_cases.head(10))
