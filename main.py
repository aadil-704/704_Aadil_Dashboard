...
if tab_selector == "Graph":
    ...
    fig_individual_criminal_cases = px.bar(individual_criminal_cases, x='NAME', y='Criminal', color='NAME',hover_data=['PARTY', 'STATE', 'CONSTITUENCY'], title='Top 10 Individuals with the Most Criminal Cases', template='plotly_dark')
