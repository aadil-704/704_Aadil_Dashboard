...
if tab_selector == "Graph":
    ...
    fig = px.bar(individual_criminal_cases, x='NAME', y='Criminal', color='PARTY', hover_data=['PARTY', 'STATE', 'CONSTITUENCY'], title='Top 10 Individuals with the Most Criminal Cases')
    st.plotly_chart(fig)
